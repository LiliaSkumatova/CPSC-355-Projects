...
donePop:      ldp     x29, x30, [sp], 16                    
            ret                                         


            .global stackFull                           // Make "stackFull" visible 
stackFull:  stp     x29, x30, [sp, -16]!                  
            mov     x29, sp                              
...
stackFullDone:      ldp     x29, x30, [sp], 16                    
            ret                                        


            .global stackEmpty                          // Make "stackEmpty" visible
stackEmpty: stp     x29, x30, [sp, -16]!                  
            mov     x29, sp                              
            adrp    base_r, top                         
            add     base_r, base_r, :lo12:top
            ldr     w1, [base_r]                        
...
stackEmptyDone:      ldp     x29, x30, [sp], 16                    
            ret                                         
